//Create the individual Message Components
    ...
    render() {
        ...
        return (
            <View key={message.id} style={styles.container}>
                ...
                <View style={[styles.messages, isCurrentUser && styles.myMessage]}>
...
//To catch bugs with typechecking, because we don't use Typescript for now
Message.propTypes = {
